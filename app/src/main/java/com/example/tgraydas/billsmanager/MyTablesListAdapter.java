...
/**
 * Created by mpsan on 09-06-2018.
 */
...
public class MyTablesListAdapter extends ArrayAdapter<Desk> {

    private  MyTablesFragment allTablesFragment;

    public MyTablesListAdapter(@NonNull MyTablesFragment allTablesFragment, Context context, @NonNull List<Desk> tables) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        takeOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                allTablesFragment.getTakeMyTableListener().takeMyTableListener(desk);
